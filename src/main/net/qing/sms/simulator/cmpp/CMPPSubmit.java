...
public class CMPPSubmit extends CMPPHeader {
	...
	String srcId;//21
	int destUsrTl;//1
	String destTerminalId;//21*destUsrTl
	int msgLenght;//1
	String msgContent;//
	String resrve;//8
...
//		}
		...
		data = new byte[8+1];
		byteBuf.readBytes(data, 0, 8);
		this.resrve = new String(data).trim();
	}
	...
	public void setResrve(String resrve) {
		this.resrve = resrve;
	}
